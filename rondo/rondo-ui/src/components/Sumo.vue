        ...
        <transition name="fade" mode="out-in" class="panel">
          <div key="cohort_panel" class="panel" v-if="activePanel == 'summary'">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                <ul>
                    <li v-for="summary, key in summaries">
                        <input type="checkbox" :key="key" :name="key" :value="key" v-model="summarize"> {{ summary }}
                    </li>
                    <input type="checkbox" v-model="summarize" value="test" id="test"> test
                </ul>
                </div>
            </div>
         </div>
          ...
          <div key="matched_panel" class="panel" v-if="activePanel == 'comparison'">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <ul>
                            <li v-for="summary, key in comparisonSummaries"><input type="checkbox" :value="key"> {{ summary }}</li>
                        </ul>
                        </div>
                    </div>
          </div>
          ...
          <div key="matched_panel" class="panel" v-if="activePanel == 'pairs'">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                <ul>
                    <li v-for="summary, key in summaries"><input type="checkbox" :value="key" > {{ summary }}</li>
                </ul>
                </div>
            </div>
